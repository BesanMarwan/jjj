...
{{--        </li>--}}
        <li class="nav-item dropdown mr-30">
            <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
               aria-haspopup="true" aria-expanded="false">
                @if (auth()->user()->user_image != '')
                    <img src="{{ asset(auth()->user()->user_image) }}" class="rounded-circle" alt="avatar">
                @else
                    <img src="{{ asset('images/users/default.png') }}" class="rounded-circle" alt="avatar">
                @endif            </a>
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{route('users.editProfile',auth()->user()->id)}}"><i class="text-info ti-settings"></i>اعدادات البروفايل</a>
                <a class="dropdown-item" href="#"><i class="text-danger ti-unlock"></i>تسجيل الخروج </a>
